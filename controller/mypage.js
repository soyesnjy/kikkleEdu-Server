...
const mypageController = {
  ...
  getKKTeacherAttendDataRead: async (req, res) => {
    ...
    try {
      const { pageNum, userClass, name, userIdx } = req.query;
...
ORDER BY a.kk_attend_created_at DESC LIMIT ? OFFSET ?;
`;
  ...
  // TODO# KK Teacher Attend Data Update
  ...
  getKKAgencyReservationDataRead: (req, res) => {
